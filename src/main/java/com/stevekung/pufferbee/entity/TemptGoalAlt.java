package com.stevekung.pufferbee.entity;
...
public class TemptGoalAlt extends Goal
{
    ...
    public TemptGoalAlt(CreatureEntity creatureIn, double speedIn, Ingredient temptItemsIn, boolean scaredByPlayerMovementIn) {
        this(creatureIn, speedIn, scaredByPlayerMovementIn, temptItemsIn);
    }

    public TemptGoalAlt(CreatureEntity creatureIn, double speedIn, boolean scaredByPlayerMovementIn, Ingredient temptItemsIn) {
